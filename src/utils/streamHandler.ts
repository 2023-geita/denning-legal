import { Message, ToolCall } from "../utils/types";
...
const handleStreamMessageEvent = (
  ...
  if (event.event === "messages/partial") {
    ...
    } else if (dataItem.type === "assistant" && dataItem.content) {
      setMessages((prevMessages) => {
        ...
        return [
          ...prevMessages,
          { id: dataItem.id, text: dataItem.content, role: "assistant" },
        ];
      });
    }
  }
